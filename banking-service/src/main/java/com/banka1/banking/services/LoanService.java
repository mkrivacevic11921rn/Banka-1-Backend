...
public class LoanService {
    ...
    public LoanService(LoanRepository loanRepository, JmsTemplate jmsTemplate, MessageHelper messageHelper, ModelMapper modelMapper, String destinationEmail, AccountRepository accountRepository) {
